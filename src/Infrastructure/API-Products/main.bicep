...
module apiVersionSet 'todo-api/versionSets/version-set.bicep' = {
...
module apiProduct 'todo-api/todo-product.bicep' = {
  name: productName
  params: {
    apimServiceName: apimServiceName
    ...
    versionSetId: apiVersionSet.outputs.apiVersionSetId
